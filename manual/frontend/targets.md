...
![targets-page](../_assets/targets-page.png)
...
![Personal Statistics](../_assets/targets_stats.png)
...
![Writeups](../_assets/targets_listing_writeups.png)
...
![VPN Warning](../_assets/targets_page_vpn_warning.png)
...
* **Gear Icon**: Clicking this icon allows you to perform actions related to the target, such as:
  ...
  * Restart a target
  ...
  ![Target Information](../_assets/target_page_target_information.png)
...
![Target Powered Off Message](../_assets/target_powered_off_message.png)
...
![Power up a target](../_assets/power_up_target.png)

1. A popup message will appear informing you that the target is about to be powered up.

>[!NOTE]
> Once powered up, the target becomes accessible to all users.
1. Click **OK** to proceed.
2. A notification will confirm that the target is in the power-up queue.
3. Shortly after, another notification will appear, indicating that the target has been successfully powered up.
4. Refresh the target's page to see the status update. A countdown timer will appear at the top of the page, showing the elapsed time until the target is automatically shut down.

![Target Shutdown Elapse Time](../_assets/target_shutdown_elapse_time.png)
